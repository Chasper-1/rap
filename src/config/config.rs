...
pub struct UiConfig {
    ...
    pub cava_sensitivity_low: f32,
    pub cava_sensitivity_mid: f32,
    pub cava_sensitivity_high: f32,
    pub cava_noise_gate: f32,
    pub cava_attack: f32,
    pub cava_tilt: f32,
    pub cava_update_ms: u64,
    pub step_offset: u16,
    pub line_x: u16,
    pub line_y: u16,
    pub line_width: u16,
    ...
    fn default_vals() -> Self {
        Config {
            ...
            ui: UiConfig {
                ...
                cava_exponent: 0.8,
                cava_sensitivity_low: 0.002,
                cava_sensitivity_mid: 0.02,
                cava_sensitivity_high: 0.16,
